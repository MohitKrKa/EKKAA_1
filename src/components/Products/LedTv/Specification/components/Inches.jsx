...
const Inches = () => {
  return (
    <div className="relative md:w-full h-auto md:max-h-[95vh] font-[Poppins]">
      <img src={tv} alt="" className="w-full" />
      <img src={ov} alt="" className='absolute -bottom-1  w-full'/>
      <h2 className="absolute bottom-6  font-[200] left-1/2 -translate-x-1/2 text-white md:text-[3vh] text-xl md:w-auto w-[80vw] text-center">
